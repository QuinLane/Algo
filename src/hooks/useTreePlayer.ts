...
import type { TreeTrace, TreeFrame } from "@/types/algorithm";
...
export function useTreePlayer(trace: TreeTrace | null) {
  ...
  const frame: TreeFrame | null = trace?.frames[step] ?? null;
