...
import type { PathfindingTrace, PathfindingFrame } from "@/types/algorithm";
...
export function useGridPlayer(trace: PathfindingTrace | null) {
  ...
  const frame: PathfindingFrame | null = trace?.frames[step] ?? null;
